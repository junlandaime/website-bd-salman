                    ...
                    <div class="item-card flex flex-col gap-y-10 md:flex-row justify-between items-center">
                        <div class="flex flex-col gap-y-3">
                            ...
                            <div>
                                ...
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $posts }}</h3>
                            </div>
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 text-sm">Event</p>
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $events }}</h3>
                            </div>
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 text-sm">Jamaah</p>
                                {{-- <h3 class="text-indigo-950 text-xl font-bold">{{ $people }}</h3> --}}
                            </div>
                        </div>
                        <div class="flex flex-col gap-y-3">
                            <svg width="46" height="46" viewBox="0 0 24 24" fill="none"
                            ...
                            <div>
                                <p class="text-slate-500 text-sm">User Web</p>
                        ...
                        <div class="flex flex-col gap-y-3">
                            ...
                            <div>
                                <p class="text-slate-500 text-sm">Foto</p>
                                <h3 class="text-indigo-950 text-xl font-bold">{{ $photos }}</h3>
                            </div>
                        </div>
                    </div>
                @endrole
