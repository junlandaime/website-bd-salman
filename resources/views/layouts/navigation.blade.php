        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @role('superadmin|admin|kapro|member')
                        <x-nav-link :href="route('dashboard')" :active="request()->routeIs('dashboard')">
                            {{ __('Dashboard') }}
                        </x-nav-link>
                    @endrole

                    @role('superadmin|admin|kapro')
                        ...
                        <x-nav-link :href="route('admin.posts.profile')" :active="request()->routeIs('admin.posts.profile')">
                            {{ __('Profile & Layanan') }}
                        </x-nav-link>
                        ...
                        {{-- <x-nav-link :href="route('admin.people.index')" :active="request()->routeIs('admin.people.index')">
                            {{ __('Manage People') }}
                        </x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button
                            ...
                            <div class="font-bold px-1">{{ Auth::user() ? Auth::user()->name : '' }}</div>
                            {{-- kapro <div class="italic px-0.5">
                                {{ Auth::user()->email }}
                            </div>) --}}
                            ( <div class="italic px-0.5">
