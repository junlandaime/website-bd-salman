            ...
            <a class="" href="">
                <div
                    ...
                    <div
                        ...
                        <img class="w-8" src="{{ asset('images/logbd.png') }}" alt="Logo Bidang Dakwah">
                    </div>
        ...
        <div class="vd wo/4 sd qo f ho oo wf yf" :class="{ 'd hh rm sr td ud qg ug jc yh': navigationOpen }">
            <nav>
                <ul class="tc _o sf yo cg ep">
                    <li><a href="{{ route('front.index') }}" class="xl"
                            :class="{ 'mk': page === 'home' }">Home</a></li>
                    <li><a href="{{ route('front.events') }}" class="xl"
                            :class="{ 'mk': page === 'events' }">Kegiatan</a></li>
                    <li><a href="{{ route('front.features') }}" class="xl"
                            :class="{ 'mk': page === 'features' }">Layanan</a></li>
                    <li class="c i" x-data="{ dropdown: false }">
                        <a href="#" class="xl tc wf yf bg" @click.prevent="dropdown = !dropdown"
                            :class="{
                                'mk': page === 'informations' || page === 'blogs' || page === 'signin' ||
                        ...
                        <ul class="a" :class="{ 'tc': dropdown }">
                            <li><a href="{{ route('front.informations') }}" class="xl"
                                    :class="{ 'mk': page === 'informations' }">Informasi</a></li>
                            <li><a href="{{ route('front.blogs') }}" class="xl"
                                    :class="{ 'mk': page === 'blogs' }">Tulisan Blog</a></li>

                        </ul>
                        <!-- Dropdown End -->
                    </li>
                    <li><a href="{{ route('front.about') }}" class="xl"
                            :class="{ 'mk': page === 'about' }">Tentang Kami</a></li>
                </ul>
            </nav>
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ route('register') }}"
                            ...
                            class="lk gh dk rg tc wf xf _l gi hi bg-[#66B161]">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}"
